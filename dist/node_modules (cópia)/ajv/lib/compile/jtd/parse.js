...
function parseDiscriminator(cxt) {
    ...
    tryParseItems(cxt, "}", () => {
        ...
        gen.if((0, codegen_1._) `${key} === ${discriminator}`, () => {
            ...
            gen.break();
        }, () => parseEmpty(Object.assign(Object.assign({}, cxt), { data: value })));
    });
...
function parseSchemaProperties(cxt, discriminator) {
    ...
    parseItems(cxt, "}", () => {
        ...
        if (additionalProperties) {
            parseEmpty(Object.assign(Object.assign({}, cxt), { data: (0, codegen_1._) `${data}[${key}]` }));
        }
        else {
...
function parsePropertyValue(cxt, key, schema) {
    parseCode(Object.assign(Object.assign({}, cxt), { schema, data: (0, codegen_1._) `${cxt.data}[${key}]` }));
}
